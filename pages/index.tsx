  ...
  return (
    <div className='p-20 px-40 h-full'>
      ...
      <div className='w-full pt-10 h-full flex flex-col justify-between gap-5 items-center'>
        ...
        <span  role='textbox' className='w-full overflow-hidden text-white border-slate-400 border-2 focus:outline-none focus:border-slate-100 p-4 block resize bg-slate-600 min-h-[100px] rounded-xl' id='resultText' contentEditable>{text}</span>
      </div>
    </div>
  )
}
